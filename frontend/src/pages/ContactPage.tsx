      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5 space-y-4">
            <Card className="p-5 rounded-2xl border-border bg-card shadow-xs space-y-3">
          ...
          <div className="md:col-span-7">
            <Card className="p-6 sm:p-8 rounded-2xl border-border bg-card shadow-sm space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full font-bold text-xs bg-primary hover:bg-primary-hover gap-2 shadow-sm">
